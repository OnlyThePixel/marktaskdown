...
/**
 * SetTaskAsDoneUseCase
 * Application use case for marking a task as done
 */
export class SetTaskAsDoneUseCase {
  private readonly taskRepository: TaskRepository;

  /**
   * Creates a new SetTaskAsDoneUseCase
   *
   ...
   *
   * @param slug - The slug of the task to mark as done
